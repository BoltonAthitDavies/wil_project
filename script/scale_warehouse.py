...
Usage:
    python3 script/scale_warehouse.py FACTOR              # uniform, both axes
    python3 script/scale_warehouse.py FX FY               # per-axis
    python3 script/scale_warehouse.py FX FY --uv N        # override UV factor
    ... --dry-run
