...
\begin{table}[htbp]
\centering
\caption{Conditions for the estimator comparison. All five estimators consume the
...
\begin{table}[htbp]
\centering
\caption{Which of the four IMU noise terms costs the EKF its accuracy. Each row
...
\scriptsize
\setlength{\tabcolsep}{4pt}
\input{tables/trajectory_per_run}
...
\begin{figure}[htbp]
  ...
  {\small\setlength{\tabcolsep}{3pt}\input{tables/example_run_summary}}
...
\begin{figure}[p]
  \centering
  \input{figures/block_colours_static}%
...
\scriptsize
\setlength{\tabcolsep}{3pt}
\input{tables/block_performance_static_orb}
\end{table}
\clearpage
\begin{table}[p]
\centering
...
\scriptsize
\setlength{\tabcolsep}{3pt}
\input{tables/block_performance_static_vins}
\end{table}
\clearpage
\begin{table}[p]
\centering
...
\scriptsize
\setlength{\tabcolsep}{3pt}
\input{tables/block_performance_static_ekf}
\end{table}
\clearpage
\begin{figure}[p]
  \centering
  \input{figures/block_colours_dynamic}%
...
\scriptsize
\setlength{\tabcolsep}{3pt}
\input{tables/block_performance_dynamic_vins}
\end{table}
\clearpage
